      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12 lg:py-16">
        ...
        <div className="mt-10 sm:mt-12 pt-6 sm:pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="https://wa.me/919767975130"
              target="_blank"
              rel="noopener noreferrer"
              onClick={() => onLinkClick?.('WhatsApp')}
              className="inline-flex items-center gap-2 rounded-lg bg-[#25D366] px-4 py-2 text-sm font-medium text-[#0a0a0a] transition-opacity hover:opacity-90"
            >
